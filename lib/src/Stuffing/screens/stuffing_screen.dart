...
import 'package:cfs_app/src/Stuffing/controllers/stuffingController.dart';
...
class StuffingScreen extends StatefulWidget {
  final String type;

  const StuffingScreen({super.key, required this.type});

  @override
  State<StuffingScreen> createState() => _StuffingScreenState();
}

class _StuffingScreenState extends State<StuffingScreen> {
  final StuffingController ctrl = Get.put(StuffingController());
  int _currentIndex = 0;
  final TextEditingController searchCtrl = TextEditingController();
  var filteredContainers = <StuffingContainerModel>[].obs;
              ...
              onLongPress: () {
                setState(() {
                  if (!cargo.isRunning) {
                    ...
                    // 🔥 Call Odoo "start"
                    ctrl.updateStuffingStatus(cargo.id, "start");
                  } else {
                    // stop & reset locally
                    ...
                    // 🔥 Call Odoo "stop"
                    ctrl.updateStuffingStatus(cargo.id, "stop");
                  }
                });
              },
